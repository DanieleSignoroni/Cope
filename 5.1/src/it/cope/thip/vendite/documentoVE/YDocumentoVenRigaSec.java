...
public class YDocumentoVenRigaSec extends DocumentoVenRigaSec {
	...
	@Override
	public void calcolaDatiVendita(DocumentoVendita testata) throws SQLException {
	...
	public int save() throws SQLException {
		...
		if ((tipoParte == ArticoloDatiIdent.KIT_NON_GEST ||
				...
				&& !isOnDB()) {
			calcolaDatiVendita((DocumentoVendita) rigaPrm.getTestata());
		}
		int rc = super.save();
		return rc;
	}
